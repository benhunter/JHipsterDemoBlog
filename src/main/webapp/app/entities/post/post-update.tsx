  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jHipsterDemoBlogApp.post.home.createOrEditLabel" data-cy="PostCreateUpdateHeading">
            <Translate contentKey="jHipsterDemoBlogApp.post.home.createOrEditLabel">Create or edit a Post</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jHipsterDemoBlogApp.post.title')}
                id="post-title"
                name="title"
                data-cy="title"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('jHipsterDemoBlogApp.post.content')}
                id="post-content"
                name="content"
                data-cy="content"
                type="textarea"
              ...
              />
              <ValidatedField
                label={translate('jHipsterDemoBlogApp.post.date')}
                id="post-date"
                name="date"
                data-cy="date"
                type="datetime-local"
              ...
              />
              <ValidatedField id="post-blog" name="blog" data-cy="blog" label={translate('jHipsterDemoBlogApp.post.blog')} type="select">
                <option value="" key="0" />
                {blogs
              ...
              <ValidatedField
                label={translate('jHipsterDemoBlogApp.post.tag')}
                id="post-tag"
                data-cy="tag"
                type="select"
                multiple
